...
\begin{itemize}
	...
	\item Tela Prefer\^encias: Nesta tela o usu\'ario pode criar, alterar, ou excluir um modo, adicionando o atraso e frequ\^encia desejados, al\'em de selecionar as op\c{c}\~oes de ativar/desativar \textit{headset bluetooth} e notifica\c{c}\~oes. Visualizar figura 10.
	\begin{figure}[H]
		\centering
		%\captionsetup{width=0.97\textwidth}
	...
	\item  Tela Sobre: Nesta tela o usu\'ario encontra informa\c{c}\~oes sobre o aplicativo, assim como informa\c{c}\~oes sobre o funcionamento do aplicativo e um tutorial de ajuda. Visualizar figura 11.
	\begin{figure}[H]
		\centering
		%\captionsetup{width=0.97\textwidth}
